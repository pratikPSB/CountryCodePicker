...
public class CountryCodePicker extends RelativeLayout {
    ...
    void refreshPreferredCountries() {
        if (mCountryPreference == null || mCountryPreference.isEmpty()) {
    ...
    void refreshCustomMasterList() {
        if (mCustomMasterCountries == null || mCustomMasterCountries.isEmpty()) {
    ...
    List<Country> getCustomCountries(@NonNull CountryCodePicker codePicker) {
        ...
        if (codePicker.getCustomCountries() == null || codePicker.getCustomCountries().isEmpty()) {
